...
public class StatueModel extends GeoModel<StatueEntity> {
	public static final Identifier MODEL = new Identifier(ScryingStatues.MOD_ID, "geo/statue/StatueModel.geo.json");
	public static final Identifier TEXTURE = new Identifier(ScryingStatues.MOD_ID, "textures/entity/statue/statue.png");
	public static final Identifier ANIMATION = new Identifier(ScryingStatues.MOD_ID, "animations/statue/statue_model.animation.json");
